...
class TradeMockDataHelper {
  ...
  static Future<TradePortfolioListDto> getMockTradePortfolios() async {
    try {
      ...
      final jsonString = await rootBundle.loadString('lib/assets/mock_data/trade/trade_portfolios.json');
  ...
  static Future<TradeHoldingsDto> getMockTradeHoldings() async {
    try {
      ...
      final jsonString = await rootBundle.loadString('lib/assets/mock_data/trade/holdings/trade_holdings.json');
      final jsonData = json.decode(jsonString) as Map<String, dynamic>;
  ...
  static Future<TradePortfolioSummaryDto> getMockTradeSummary() async {
    try {
      ...
      final jsonString = await rootBundle.loadString('lib/assets/mock_data/trade/trade_summary.json');
      final jsonData = json.decode(jsonString) as Map<String, dynamic>;
  ...
  static Future<TradeCalendarDto> getMockTradeCalendar() async {
    try {
      ...
      final jsonString = await rootBundle.loadString('lib/assets/mock_data/trade/calander/trade_calendar.json');
      final jsonData = json.decode(jsonString) as Map<String, dynamic>;
