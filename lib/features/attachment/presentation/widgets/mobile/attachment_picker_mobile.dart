...
class _AttachmentPickerMobileState extends ConsumerState<AttachmentPickerMobile> {
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      final pending = PendingAttachment(fileName: image.name, filePath: image.path, previewUrl: image.path);
  ...
  Future<void> _pickFile() async {
    try {
      ...
      final pending = PendingAttachment(fileName: file.name, filePath: file.path, previewUrl: file.path);
