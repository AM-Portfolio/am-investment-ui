...
class PendingAttachment {
  PendingAttachment({required this.fileName, required this.filePath, this.fileBytes, this.previewUrl});
...
class AttachmentItem {
  AttachmentItem.pending(this.pendingAttachment) : uploadedUrl = null, isUploaded = false;

  AttachmentItem.uploaded(this.uploadedUrl) : pendingAttachment = null, isUploaded = true;
