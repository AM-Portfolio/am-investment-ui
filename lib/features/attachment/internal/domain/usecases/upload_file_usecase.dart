...
class UploadFileUseCase {
  ...
  Future<UploadResult> call({required String filePath, required String folder, Map<String, String>? metadata}) async {
    ...
    return _repository.uploadFile(fileContent: base64Content, filename: filename, folder: folder);
  }
}
