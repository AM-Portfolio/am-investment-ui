...
class ListResourcesUseCase {
  ...
  Future<List<CloudinaryResource>> call({String? folder, int? limit, String? nextCursor}) =>
      _repository.listResources(folder: folder, maxResults: limit ?? 100, nextCursor: nextCursor);
}
