...
abstract class CloudinaryRepository {
  ...
  Future<CloudinaryResource> getResource({required String publicId, String resourceType = 'image'});
  ...
  /// Delete a resource
  Future<bool> deleteResource({required String publicId, String resourceType = 'image'});

  /// Delete a file (alias for deleteResource)
  Future<void> deleteFile({required String publicId}) => deleteResource(publicId: publicId);
