...
class CloudinaryMapper {
  ...
  static List<CloudinaryResource> fromResourceDtoList(List<CloudinaryResourceDto> dtos) =>
      dtos.map(fromResourceDto).toList();

  /// Map signature response DTO to SignatureDetails entity
  static SignatureDetails fromSignatureResponseDto(SignatureResponseDto dto) => SignatureDetails(
