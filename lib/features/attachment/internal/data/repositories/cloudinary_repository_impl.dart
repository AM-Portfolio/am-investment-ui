...
class CloudinaryRepositoryImpl implements CloudinaryRepository {
  CloudinaryRepositoryImpl({required CloudinaryRemoteDataSource remoteDataSource})
  ...
  @override
  Future<CloudinaryResource> getResource({required String publicId, String resourceType = 'image'}) async {
    try {
      final resourceDto = await _remoteDataSource.getResource(publicId: publicId, resourceType: resourceType);
  ...
  @override
  Future<bool> deleteResource({required String publicId, String resourceType = 'image'}) async {
    try {
      final deleteDto = await _remoteDataSource.deleteResource(publicId: publicId, resourceType: resourceType);
