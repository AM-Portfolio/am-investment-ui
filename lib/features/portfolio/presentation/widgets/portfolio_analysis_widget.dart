...
class PortfolioAnalysisWidget extends StatelessWidget {
  ...
  Widget _buildAllocationChart(BuildContext context, dynamic summary) {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
  ...
  Widget _buildTopPerformers(BuildContext context, dynamic summary) {
    final performers = [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ...performers.map((performer) => ListTile(
  ...
  Widget _buildRiskAnalysis(BuildContext context, dynamic summary) {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
  ...
  Widget _buildRiskIndicator(String title, double value, Color color) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
