...
/// Category type for asset holdings
enum CategoryType {
...
class HoldingsBreakdown extends StatefulWidget {
  ...
  final Function(String categoryName, List<AssetHolding> assets, CategoryType categoryType)? onCategoryTap;
          ...
          if (holdingsMap.isEmpty)
            ...
            ...holdingsMap.entries.map((entry) {
              ...
              return Card(
                ...
                child: InkWell(
                  onTap: () {
                    // Use callback if provided, otherwise handle navigation internally
