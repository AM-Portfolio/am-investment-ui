import 'package:am_common_ui/am_common_ui.dart' as am_ui;
...
class AppLogger {
  ...
  static void initialize() {
    ...
    _isInitialized = true;
    am_ui.CommonLogger.info('AppLogger initialized for environment: ${EnvironmentConfig.environment.name}', tag: 'Logger');
  }
  ...
  static void apiRequest(String method, String url, {String? tag, Map<String, dynamic>? headers, body}) {
  ...
  static void apiResponse(String method, String url, int statusCode, {String? tag, body, int? duration}) {
