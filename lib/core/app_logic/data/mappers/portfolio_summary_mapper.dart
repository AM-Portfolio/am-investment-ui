...
class PortfolioSummaryMapper {
  ...
  static PortfolioSummary fromApiModel(ApiPortfolioSummaryResponse apiModel) {
  ...
  static Map<MarketCapCategory, List<MarketCapHolding>> _mapMarketCapBreakdown(
      Map<String, List<ApiMarketCapHolding>> apiBreakdown) {
  ...
  static MarketCapHolding _mapMarketCapHolding(ApiMarketCapHolding apiHolding) {
    // Create identity
  ...
  static List<String> _generateRecommendations(ApiPortfolioSummaryResponse apiModel) {
  ...
  static int _calculateTotalHoldings(Map<String, List<ApiMarketCapHolding>> marketCapHoldings) {
  ...
  static ApiMarketCapHolding _mapToApiMarketCapHolding(MarketCapHolding domainHolding) {
  ...
  /// Validation helper
  static bool isValidApiResponse(ApiPortfolioSummaryResponse? apiModel) {
