...
class UserMapper {
  ...
  static User fromDto(UserResponse dto) {
    return User(
      id: dto.id,
      email: dto.email,
      ...
      userName: '', // Not included in current DTO, could be added
      roles: [], // Not included in current DTO, could be added
      isActive: true, // Default value, could be added to DTO
      lastLoginAt: null, // Not included in current DTO, could be added
  ...
  static UserResponse toDto(User user) {
    return UserResponse(
      ...
      avatarUrl: null, // Not included in current domain entity
  ...
  static UpdateUserRequest toUpdateRequestDto(User user) {
  ...
  static User fromJson(Map<String, dynamic> json) {
    ...
    return User(
      ...
      password: json['password'] as String? ?? '', // Include password for test users
      firstName: firstName,
      lastName: lastName,
      phoneNumber: json['phone'] as String? ?? json['phoneNumber'] as String? ?? json['phone_number'] as String? ?? '',
  ...
  static Map<String, dynamic> toJson(User user) {
    return {
      ...
      if (user.lastLoginAt != null) 'lastLoginAt': user.lastLoginAt!.toIso8601String(),
