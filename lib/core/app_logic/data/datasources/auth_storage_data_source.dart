...
class AuthStorageDataSource {
  ...
  Future<void> saveAuthData({
    ...
    try {
      ...
      AppLogger.debug(
        'Authentication data saved to persistent storage',
        tag: 'AuthStorageDataSource',
      );
  ...
  Future<AuthState?> loadAuthData() async {
    ...
    try {
      ...
      if (token != null && userData != null) {
        ...
        AppLogger.info(
          'Authentication data loaded from storage for user: ${user.email}',
          tag: 'AuthStorageDataSource',
        );
        AppLogger.methodExit(
          'loadAuthData',
        ...
        AppLogger.debug(
          'No authentication data found in storage',
          tag: 'AuthStorageDataSource',
        );
        AppLogger.methodExit(
          'loadAuthData',
  ...
  Future<void> clearAuthData() async {
    ...
    try {
      ...
      AppLogger.debug(
        'Authentication data cleared from persistent storage',
        tag: 'AuthStorageDataSource',
      );
      AppLogger.methodExit(
        'clearAuthData',
  ...
  Future<void> updateTokenData({
    ...
    try {
      ...
      final updates = <Future<bool>>[prefs.setString(_tokenKey, token)];
      ...
      AppLogger.debug(
        'Token data updated in persistent storage',
        tag: 'AuthStorageDataSource',
      );
      AppLogger.methodExit(
        'updateTokenData',
  ...
  Future<bool> hasAuthData() async {
    ...
    try {
      final prefs = await SharedPreferences.getInstance();
      final hasData =
          prefs.containsKey(_tokenKey) && prefs.containsKey(_userKey);
