...
class DirectionStatusSelector extends StatelessWidget {
  ...
  Widget _buildWebLayout(ThemeData theme, bool isTablet, bool isDesktop) => Row(
    ...
    children: [
      ...
      Padding(
        ...
        child: Container(width: 1, height: 32, color: theme.colorScheme.outline.withOpacity(0.2)),
      ),
  ...
  Widget _buildDirectionSection(ThemeData theme, bool isMobile) => Row(
    ...
    children: [
      ...
      const SizedBox(width: 8),
      Text('Direction', style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, fontSize: 13)),
  ...
  Widget _buildStatusSection(ThemeData theme, bool isMobile) => Row(
    ...
    children: [
      ...
      const SizedBox(width: 8),
      Text('Status', style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, fontSize: 13)),
      const SizedBox(width: 10),
  ...
  Widget _buildStatusDropdown(ThemeData theme, bool isMobile) => Container(
    ...
    child: DropdownButtonHideUnderline(
      child: DropdownButton<TradeStatuses>(
        ...
        style: theme.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.w500, fontSize: isMobile ? 12 : 14),
        onChanged: (newValue) {
          if (newValue != null) {
