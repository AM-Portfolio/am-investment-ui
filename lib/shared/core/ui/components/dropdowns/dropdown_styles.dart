...
class DropdownStyles {
  ...
  static Color getBorderColor(BuildContext context, {Color? primaryColor, Color? borderColor, bool enabled = true}) {
  ...
  static Color getTextColor(
    ...
    final effectivePrimaryColor = getPrimaryColor(context, primaryColor);
    return isPlaceholder ? effectivePrimaryColor.withOpacity(hintOpacity) : effectivePrimaryColor;
  }

  /// Get effective icon color
  static Color getIconColor(BuildContext context, {Color? primaryColor, bool enabled = true}) {
  ...
  static BoxDecoration createDecoration(
    ...
    color: getBackgroundColor(context, primaryColor: primaryColor, backgroundColor: backgroundColor, enabled: enabled),
    borderRadius: BorderRadius.circular(borderRadius),
    border: Border.all(
      color: getBorderColor(context, primaryColor: primaryColor, borderColor: borderColor, enabled: enabled),
    ),
  );
