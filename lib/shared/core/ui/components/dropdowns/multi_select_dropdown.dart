...
class _MultiSelectDropdownState<T> extends State<MultiSelectDropdown<T>> {
  ...
  Widget _buildSuffixIcon() {
    final iconColor = DropdownStyles.getIconColor(context, primaryColor: widget.primaryColor);
    ...
    return Icon(_isOpen ? Icons.expand_less : Icons.expand_more, size: widget.iconSize, color: iconColor);
  }
