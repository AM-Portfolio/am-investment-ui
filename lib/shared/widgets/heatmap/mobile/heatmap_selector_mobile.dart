...
class _HeatmapSelectorMobileState extends State<HeatmapSelectorMobile>
  ...
  void _showMetricSelector(BuildContext context) {
    _showSelectorDialog(
      ...
      getDisplayText: (metric) => metric.displayName,
      getSubtitle: (metric) => metric.shortName,
    );
  }
  ...
  void _showSectorSelector(BuildContext context) {
    _showSelectorDialog(
      ...
      getDisplayText: (sector) => sector.displayName,
      getSubtitle: (sector) => sector.shortName,
    );
  }
  ...
  void _showMarketCapSelector(BuildContext context) {
    _showSelectorDialog(
      ...
      getDisplayText: (marketCap) => marketCap.displayName,
      getSubtitle: (marketCap) => marketCap.shortName,
    );
  }
  ...
  void _showLayoutSelector(BuildContext context) {
    _showSelectorDialog(
      ...
      getDisplayText: (layout) => layout.displayName,
      getSubtitle: (layout) => 'View as ${layout.displayName.toLowerCase()}',
      getIcon: (layout) => layout.icon,
    );
  }
